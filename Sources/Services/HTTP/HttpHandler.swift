...
public class HttpHandler:NetworkHandler {
    public class func valueForKey(request:HTTPRequest, key:String) -> String? {
    ...
    public class func responseReq(response: HTTPResponse, returnCode:ReturnCode, errMsg:String, data:Dictionary<String,Any>?) {
